...
func TestEmptyResponse(t *testing.T) {
	...
	sensors, err := ts.Query().Device("testdevice").Get()
...
func TestAverageAggregationPT1H(t *testing.T) {
	...
	sensors, err := ts.Query().Device("testdevice").Aggregate("PT1H", "avg").Get()
...
func TestAverageAggregationPT24H(t *testing.T) {
	...
	sensors, err := ts.Query().Device("testdevice").Aggregate("PT24H", "avg").Get()
...
func TestAverageAggregationP1MFails(t *testing.T) {
	...
	sensors, err := ts.Query().Device("testdevice").Aggregate("P1M", "avg").Get()
...
func TestMaxMinAggregationPT1H(t *testing.T) {
	...
	sensors, err := ts.Query().Device("testdevice").Aggregate("PT1H", "max,min").Get()
