...
func (mock *WaterQualityServiceMock) GetByID(ctx context.Context, id string, from time.Time, to time.Time) (*domain.WaterQualityTemporal, error) {
	...
	return mock.GetByIDFunc(ctx, id, from, to)
}
