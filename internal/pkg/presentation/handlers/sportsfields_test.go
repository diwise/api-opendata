...
const expectedOutputWithFields string = `{"data":[{"categories":["ice-rink"],"id":"id0","location":{"type":"Point","coordinates":[17.428771593881844,62.42103804538807]},"name":"test0","publicAccess":"always"},{"categories":["ice-rink","flood-lit"],"id":"id1","location":{"type":"Point","coordinates":[17.428771593881844,62.42103804538807]},"name":"test1","publicAccess":"never"}]}`
